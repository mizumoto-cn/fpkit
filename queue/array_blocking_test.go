...
func TestArrayBlockingQueueRacePush(t *testing.T) {
	...
	print("20000 threads pushed with 10ms timeout, the result is:", q.Size())
	// things like 20000 threads pushed with 10ms timeout, the result is: 19125
	assert.Less(t, q.Size(), 20000)
	// usually the result is less than 20000, like 19125
}
...
func TestArrayBlockingQueueRacePop(t *testing.T) {
	...
	print("20000 threads popped with 10ms timeout, the result is:", q.Size())
	// things like 20000 threads popped with 10ms timeout, the result is: 875
